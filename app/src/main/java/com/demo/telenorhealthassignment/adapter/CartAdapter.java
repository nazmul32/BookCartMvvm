...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.GenericViewHolder> {
    ...
    public static class CartViewHolder extends GenericViewHolder {
    ...
    public void onBindViewHolder(GenericViewHolder holder, int position) {
        if (holder.getItemViewType() == Constants.NORMAL_VIEW_TYPE) {
            ...
            Glide.with(context)
                    ...
                    .into(cartViewHolder.ivPreview);
            cartViewHolder.tvTitle.setText(bookDataDetails.get(position).getTitle());
            cartViewHolder.tvSubTitle.setText(bookDataDetails.get(position).getSubTitle());
            cartViewHolder.ivAddToCart.setImageResource(R.drawable.ic_cart_checked);
            cartViewHolder.ivWishList.setImageResource(R.drawable.ic_wish_list_unchecked);
        }
    }
